...
bob_alice_same_word/B
```

We can see the difference is `r abs(sum(words_data$squared_freq) - bob_alice_same_word/B)`, which is very small difference. Thus, we can conclude it is the same.
